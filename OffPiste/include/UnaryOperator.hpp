...
namespace OP {
    ...
    OVERLOAD_UNARY_OPERATOR(sinh, sinh_forward, sinh_backward)
    OVERLOAD_UNARY_OPERATOR(cosh, cosh_forward, cosh_backward)
    OVERLOAD_UNARY_OPERATOR(tanh, tanh_forward, tanh_backward)
