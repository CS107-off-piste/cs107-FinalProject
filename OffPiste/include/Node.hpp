...
class Node {
 public:
  ...
  /**
   * Compute gradient using reverse-mode, starting from this Node.
   * This traverses the graph all the way back to the input Nodes.
   */
  void backward();
   ...
   * then this Node is a multiplication node that adds its child nodes when
   * computing this Node's value and derivative in forward mode.
